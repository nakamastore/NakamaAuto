...
const { adminIds, verif, thankyou, megaphone, no, warning, wl, dl, arrow1, arrow2, arrow3, StoreName, bot, owner, world } = require('../config.json');
...
module.exports = {
  ...
  async execute(message, args) {
    ...
    try {
      ...
      return message.reply(`${verif} Product added successfully.`);
    } catch (error) {
