...
const { yourBotId, adminIds, prefix, verif, thankyou, megaphone, no, warning, wl, dl, arrow1, arrow2, arrow3, StoreName, bot, owner, world } = require('../config.json');
...
module.exports = {
  ...
  async execute(message, args) {
    if (!adminIds.includes(message.author.id) && message.author.id !== yourBotId) {
