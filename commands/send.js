...
const { adminIds, prefix, verif, thankyou, roleToAdd,megaphone,buylogChannelId, no, warning, wl, bgl, dl, arrow1, arrow2, arrow3, StoreName, bot, owner, world } = require('../config.json');
    ...
    try {
      ...
      if (product.type === 'yes') {
        ...
        const embedDM = new EmbedBuilder()
          .setColor("Random")
          .setTitle(`${verif} ┆ Send Successfully`)
          .setDescription(`
        You have received **${quantity} ${product.name.replace(/"/g, '')}** for **${totalPrice}${wl}**
